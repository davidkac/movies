<x-layout>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-15 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form method="POST" action="{{ route('login.store') }}" class="space-y-4 border border-gray-300 rounded-lg p-6 shadow-md">
                @csrf
                <div>
                ...
                <div class="mt-6">
                    <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white pl-2 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Log in</button>
                </div>
            </form>
        </div>
</x-layout>